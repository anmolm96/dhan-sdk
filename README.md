...
```sh
npm install git+ssh://git@github.com:anmolm96/dhan-sdk.git
```
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/anmolm96/dhan-sdk/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/anmolm96/dhan-sdk/issues) with questions, bugs, or suggestions.
